...
class TicketsTest < ApplicationSystemTestCase
  ...
  test "should create ticket" do
    ...
    fill_in "Driver", with: @ticket.driver_id
    fill_in "Kind", with: @ticket.kind
    fill_in "Opened at", with: @ticket.opened_at
  ...
  test "should update Ticket" do
    ...
    fill_in "Closed at", with: @ticket.closed_at.to_s
    fill_in "Description", with: @ticket.description
    fill_in "Driver", with: @ticket.driver_id
    fill_in "Kind", with: @ticket.kind
    fill_in "Opened at", with: @ticket.opened_at.to_s
    fill_in "Status", with: @ticket.status
