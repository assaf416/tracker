...
class PassengersTest < ApplicationSystemTestCase
  ...
  test "should create passenger" do
    ...
    fill_in "Device", with: @passenger.device_id
    fill_in "Driver", with: @passenger.driver_id
    fill_in "Image url", with: @passenger.image_url
    fill_in "Name", with: @passenger.name
    fill_in "Rating", with: @passenger.rating
    fill_in "Ride", with: @passenger.ride_id
