class DevicesController < ApplicationController
  ...
  private
    ...
    def device_params
      params.expect(device: [ :kind, :user_id, :name, :settings, :type, :model, :driver_id, :last_location, :last_location_at, :recent_message, :system_message, :error_id, :avatar, :ssid ])
    end
end
