class RidesController < ApplicationController
  ...
  private
    ...
    def ride_params
      params.expect(ride: [ :driver_id, :customer_id, :from_location, :from_address, :accpeted_at, :arrived_to_customer_at, :dropped_at, :drop_location, :pickup_location, :status, :error_message ])
    end
end
